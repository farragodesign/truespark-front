...
const Login = ({ onClick, isLogin ,onSignup }) => {
    ...
    return (
        // the login popup component
                ...
                <div className={`overflow-hidden -translate-y-100 opacity-0  absolute p-4 w-11/12 md:w-1/2 lg:w-1/4 mx-4 bg-white rounded-lg border border-gray-200 shadow-md sm:p-6 lg:p-8 dark:bg-gray-800 dark:border-gray-700 transition-all duration-1000 ${isLogin && 'translate-y-0 opacity-100'}`}>
                    ...
                    <form className="space-y-6" onSubmit={(e) => loginHandler(e)}>
                        ...
                        <div className="text-sm font-medium text-gray-500 dark:text-gray-300">
                            Not registered? <span onClick={onSignup} className="text-blue-700 hover:underline dark:text-blue-500">Create account</span>
                        </div>
                    </form>
